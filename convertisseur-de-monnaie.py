...
equation = StringVar()
résult2 = Entry(gui, textvariable=equation,width=60).place(x=50, y=150) 
...
Button(gui, text="calcule", command=transition(),width=20).place(x=9, y=180)
result3 = Entry(gui, textvariable=résultat,width=70).place(x=40,y=450)
